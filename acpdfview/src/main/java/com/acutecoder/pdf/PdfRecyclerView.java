...
final class PdfRecyclerView extends RecyclerView {
    ...
    public PdfRecyclerView(Context context, float scale) {
        super(context);
    ...
    int getScaleDuration() {
        return mScaleDuration;
    }

    void setScaleDuration(int duration) {
    ...
    void setZoomDuration(int zoomDuration) {
        this.mScaleDuration = zoomDuration;
    }

    int calculateScroll(int dy) {
        if (dy == 0) {
            return 0;
        } else {
    ...
    void zoom(float startVal, float endVal) {
    ...
    private final class GestureListener extends SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (mScaleFactor == mDefaultScaleFactor) {
                ...
                endFactor = mMaxScaleFactor / 2;
            } else if (mScaleFactor == mMaxScaleFactor / 2) {
                mScaleCenterX = e.getX();
                mScaleCenterY = e.getY();
